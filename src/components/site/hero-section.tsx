  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center text-center text-white">
      ...
      <div className="relative z-10 flex flex-col items-center px-4">
        <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight drop-shadow-lg animate-fade-in-up [animation-delay:200ms]">
          Сердце Кавказа
        </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4 animate-fade-in-up [animation-delay:600ms]">
          <Button asChild size="lg" className="font-semibold transition-transform hover:scale-105 rounded-full px-8 shadow-lg">
            <Link href="#attractions">Исследовать</Link>
          </Button>
          <Button asChild size="lg" variant="secondary" className="transition-transform hover:scale-105 rounded-full px-8 shadow-lg">
            <Link href="#routes">Найти свой маршрут</Link>
          </Button>
        </div>
      </div>
